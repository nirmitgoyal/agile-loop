...
The dashboard serves `http://127.0.0.1:8765` by default and polls the runner status every 15 seconds. It only shows the non-done queue, current status, current stage, and blocked reason when blocked.
